package dev.veeso.opentapo.mobile.voice
...
import dev.veeso.opentapo.mobile.data.DeviceController
 ...
 *   et `https://opentapo.veeso.dev/toggle?device=…&state=…`
...
class VoiceActionActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        const val ACTION_TOGGLE = "dev.veeso.opentapo.mobile.voice.TOGGLE"
        const val ACTION_ALL_ON = "dev.veeso.opentapo.mobile.voice.ALL_ON"
        const val ACTION_ALL_OFF = "dev.veeso.opentapo.mobile.voice.ALL_OFF"
