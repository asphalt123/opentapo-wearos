package dev.veeso.opentapo.mobile.account
...
object AccountStore {
    ...
    fun switch(context: Context, id: String): Boolean {
        ...
        if (creds != null) {
            dev.veeso.opentapo.mobile.SyncHelper.sendCredentialsToWear(context, creds.username, creds.password)
            dev.veeso.opentapo.mobile.SyncHelper.sendCredentialsToWearViaMessage(context, creds.username, creds.password)
        }
