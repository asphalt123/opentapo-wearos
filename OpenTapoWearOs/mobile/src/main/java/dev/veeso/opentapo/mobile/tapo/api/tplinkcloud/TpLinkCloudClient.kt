package dev.veeso.opentapo.mobile.tapo.api.tplinkcloud

import android.util.Log
import dev.veeso.opentapo.mobile.tapo.api.tplinkcloud.request.ApiRequest
import dev.veeso.opentapo.mobile.tapo.api.tplinkcloud.request.LOGIN_METHOD
import dev.veeso.opentapo.mobile.tapo.api.tplinkcloud.request.params.LoginParams
import dev.veeso.opentapo.mobile.tapo.api.tplinkcloud.response.ApiResponse
import dev.veeso.opentapo.mobile.tapo.api.tplinkcloud.response.result.LoginResult
